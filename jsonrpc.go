...
var rpcHandlers = map[string]RPCHandler{
	...
	"getRdpConsoleState":         {Func: rpcGetRDPConsoleState},
	"getRdpDevUpdateStatus":      {Func: rpcGetRDPDevelopmentUpdateStatus},
	...
	"setRdpConsoleState":         {Func: rpcSetRDPConsoleState, Params: []string{"enabled"}},
	"tryRdpDevUpdate":            {Func: rpcTryRDPDevelopmentUpdate},
